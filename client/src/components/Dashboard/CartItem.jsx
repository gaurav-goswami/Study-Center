    ...
    <>
      <div className="w-[100%] p-2 flex">
        ...
        <div className="flex flex-col gap-1">
          <Heading style="text-yellow-100 text-lg md:text-xl">
            {courseName}
          </Heading>
          <Paragraph styles="text-sm" color="text-pure-greys-200">
            {category?.name}
          </Paragraph>
        ...
        <div className="flex flex-col gap-2">
          <button
            ...
            className="flex gap-1 p-3 bg-pure-greys-700 text-pink-800"
          >
            <AiFillDelete />
            Remove
          </button>
