...
const AboutCount = () => {
    ...
    const countData = [
        ...
        },
        {
            name : "Mentors",
            data : 6500,
            icon : <GiTeacher className='text-xl md:text-3xl text-white max-[530px]:hidden'/>
        },
        {
            name : "Courses",
            data : 500,
            icon : <BsFillCameraVideoFill className='text-xl md:text-3xl text-white max-[530px]:hidden'/>
        },
        {
            name : "Placed Students",
            data : 20000,
            icon : <PiStudentFill className='text-xl md:text-3xl text-white max-[530px]:hidden'/>
        }
    ]
