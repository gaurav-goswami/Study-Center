          ...
          <div className="min-h-screen">
            <div className="w-[90%] md:w-[80%] xl:w-[70%] mx-auto flex gap-2 my-5 flex-col md:flex-row">
              <div className="md:w-[50%] w-[100%]">
                <Heading style="text-3xl md:text-5xl font-extrabold text-yellow-200">
                  Our Story
                </Heading>

                <Paragraph
                  color="text-pure-greys-300"
                  styles="text-lg md:text-xl my-2"
                >
                  ...
                  learning opportunities in a rapidly evolving digital world. As
