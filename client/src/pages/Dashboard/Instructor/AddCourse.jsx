...
const AddCourse = () => {
  return (
    <DashboardWrapper>
      <div className="w-full md:w-[80%] lg:w-[1200px] p-1 flex flex-col gap-2 mx-auto">
        <Heading style="text-xl md:text-2xl xl:text-4xl font-semibold">
          Add <HighLightText color="text-yellow-100">Course</HighLightText>{" "}
        </Heading>
