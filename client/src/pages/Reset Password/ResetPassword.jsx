          ...
          {loading ? (
            ...
            <div className="sm:w-[90%] md:w-[400px] p-4 flex flex-col gap-6 rounded-md bg-blue-800">
              ...
              <Paragraph color="text-pure-greys-100">
                {emailSent
                  ? `We have sent you an email to reset your password to ${email}`
                ...
                <form onSubmit={sendResetPasswordToken}>
                  <label className="flex flex-col gap-2 text-pure-greys-200">
                    ...
                    <input
                      ...
                      className="outline-none px-2 py-3 rounded-md text-pure-greys-25 bg-richblue-800 placeholder:text-pure-greys-400"
                      value={email}
              ...
              {!emailSent ? (
                <button
                  className="bg-yellow-200 p-2 rounded-md outline-none font-semibold"
                  onClick={sendResetPasswordToken}
                >
                  Reset Password
                </button>
              ) : (
