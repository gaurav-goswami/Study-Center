          ...
          <div className="grid place-items-center my-8 h-[500px]">
            <div className="w-max h-max justify-center items-center m-auto flex flex-col gap-8">
              ...
              <OtpInput
                ...
                numInputs={6}
                renderSeparator={
                  <span className="text-white w-[20px] text-center">
                    &#9135;
                  </span>
                }
                renderInput={(props) => (
              ...
              <form onSubmit={handleSignUp} className="flex gap-4 items-center">
                <button
                  className="p-2 rounded-md outline-none font-semibold flex gap-2 items-center text-center bg-yellow-100"
                  type="submit"
                >
                  Verify OTP
                </button>
                ...
                <span
                  className="flex gap-1 items-center text-pure-greys-200 cursor-pointer"
                  onClick={sendOtp}
                >
