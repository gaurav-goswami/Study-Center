...
export const cartSlice = createSlice({
    ...
    reducers : {
        ...
        addToCart : (state, action) => {
            ...
            const courseIndex = state.cart.findIndex((currItem) => currItem._id === course._id);
            ...
            if(courseIndex >=0) return toast.error("Course already present in cart");
        ...
        removeFromCart : (state, action) => {
            ...
            const courseIndex = state.cart.findIndex((currItem) => currItem._id === courseId);
